...
from pn_utilities import PNServer, log, OpensubtitlesHash, normalizeString, TraducirLenguaje, calcular_SublightHash
...
if params['action'] == 'search':
  ...
  for lang in urllib.unquote(params['languages']).decode('utf-8').split(","):
    item['3let_language'].append(TraducirLenguaje(lang,0,1))
